...
**Current corrected production:** `s12_result.wl`, SHA256 `4ed44edf3d2c0274249792e21a8b1c7a9bff0ca9ec7c10f07cb072e54a1e45bd`. The verified S08 polar-integration error is fixed; [the current analytical report](../bigTMD_comparison/Hqg_v3/s04_result.md) records exact agreement for all 18 coefficients. Original production/comparison and numerical-generation acceptance statements below are historical where superseded by the correction ledger.
...
The separate [analytical report](../bigTMD_comparison/Hqg_v3/s04_result.md) compares this channel's unchanged current F hats with pinned BigTMD commit `6e97635d21a63b7975b2e7f5891edc0c35c4dc0c`. 4 finite-delta differences; other compared coefficients agree. Cause unlocalized. Channel and all coefficient classes included. The exact-algebra claims are conditional on the declared reconstruction of printed decimal constants and the report's color, charge, scale, branch and distribution conventions.

Input SHA256: `0c31db0e92387801fe41300d055bcf793ddbf231ff94624fd88f6153d12c958c`. Comparison SHA256: `f99e77ed2ddbe802b44aa99e496463bb9bd636e8f4d7259c69c0f99f8cb6926f`. Report SHA256: `e43865c26fd42b81e80fc4f69fc4114cd11cee26f5b910b00b08074c96992581`. The comparison-directory README and receipts bind the source, result, proof-cache and validation identities. No production expression or existing independent-validation caveat is superseded by this comparison.

## S08 polar-integration correction and historical-result invalidation

The discrepancy investigation independently proved that the original singlePolarCoefficient mapped early-return path lost its logarithmic-integral contributions. ML(1,0) lacked its epsilon coefficient; direct angular quadrature and paper F18 agree and refute that old value. The branch-valued source correction passes both checks, with exact symbolic F18 residual zero, in ../bigTMD_comparison/Hqg_v3/s09_result.wl and s10_result.wl. The previous S08/S11/S12 production artifacts and dependent S13 caches/results are preserved under ../bigTMD_comparison/Hqg_v3/s10_provenance/production_before_correction, and their old acceptance statements above are historical. They are not valid current production inputs. Dependent numerical outputs must not be treated as corrected predictions.

Regeneration contract: fix the mapped branch at S08, require every integral term to be retained and evaluated, reuse only source-proven unaffected master branches with exact hashes, and recompute the affected positive-ML masters. Independent masters may use up to eight Engine15 kernels with unique atomic output paths. Subsequent real endpoints, complete pole checks, final hats and analytical comparisons must be regenerated and validated from the corrected angular result. Author channel coefficients cannot set the corrected production value.

S11 correction regeneration contract: compare each old/new complete angular master before reusing a real-term checkpoint. Reuse is permitted only for exact-equal masters with unchanged S07 and mathematical S11 inputs; bind the old cache hash and the new source/input hash in a transport receipt. Recompute other real terms from the corrected masters. Independent per-term evaluation may use up to eight local kernels and unique atomic cache writes; aggregate complete terms in deterministic mode/index order and assemble branches serially to avoid shared final writes. All original soft/ordinary/support checks remain.

Accepted corrected S08: s08_angular_integrals.wl SHA256 6afec6b357d7b2cef522e9c888843779729352cd0c43f460d521205b99b31587; s08_result.wl SHA256 04dc7b451e4c234336e8a15cc55a26ce16f4ae55e5992ec51ccec71aa63960dc; s08_cache/ and s08_angular_integrals_run.log. All81 requested masters returned complete values and passed the integral-evaluation and angular-pole gates. The single-polar mapped Return is removed and escaped control-flow output is rejected. The inherited-cache manifest is ../bigTMD_comparison/Hqg_v3/s10_provenance/s10_cache_invalidation.json. Other conventions are unchanged. This acceptance supersedes the old S08 artifact identity; downstream endpoint/final-hat acceptance requires corrected inputs.

Accepted real-cache transport: ../bigTMD_comparison/Hqg_v3/s11_result.wl SHA256 b6dd1668c5f6a61cc2f0064517cab770c2e63219a8ca4b92211cda55b3656f49. It proves current S07 bindings, the corrected ML(1,0) identity, unchanged mathematical S11 evaluation code, and exact complete-master equality before transporting265 historical term values. The other69 terms are excluded. Each inherited cache carries both old/new angular result hashes, its old cache hash and the complete-master equality flag. No branch aggregate or final real coefficient is inherited by this transport.

Accepted corrected S11 real output: s11_real_phase_space.wl SHA256 5149f4f9e1d39959c2a76cfe831ad5bce84d3009af28091c8f510cb9a1515b0c; s11_result.wl SHA256 c593c6e93c2e34479ca6b2dcb339d15af6ef54bbccdb6fac39344f9bf8ef2439; s11_cache/ and s11_real_phase_space_run.log. All334 terms have complete ordinary/soft values;69 were regenerated and265 passed the recorded exact-input transport. All four branch assemblies completed and retained the original soft/support and logarithmic-plus gates. Coupling removal, branch definitions, phase space and plus basis are unchanged. Final combined pole cancellation remains the S12 gate.

Accepted corrected-real impact: ../bigTMD_comparison/Hqg_v3/s12_result.wl SHA256 9442f8a310807882b252eeb7d5120adf4fbe72cf90bb4f1b515556ca229985ed. All12 non-delta real distributions are exactly unchanged at generic color. The corrected finite real delta cancels the historical BigTMD tensor discrepancy exactly for Pg/Ppp and both branches. This establishes the own S08 polar-integral error as the cause of the complete historical Hqg mismatch. The receipt transports unchanged finite contraction caches and source-bound expression/assumption-hash caches; final consumers retain exact expression-hash checks. The production S12 entry point must still rerun its full reconstruction, pole, boundary and export gates. It remains serial because its existing implementation writes a shared pole ledger and final aggregate; prior expensive independent stages used eight kernels.

Final ordinary-boundary equality reuse: ../bigTMD_comparison/Hqg_v3/s15_bind_boundary_proofs.wl binds the old producer and accepted final result to their frozen manifest, verifies both evaluated sides against their exact expression/assumption hashes and proves current cached sides identical. s12_cache/s12_boundary_proofs.wl stores the equality tuple hashes and all source/proof input hashes. S12 verifies those bindings before use and reuses a proof only for exactly identical right/left/assumption tuples; changed tuples run the original symbolic gate. This avoids recomputing the unchanged Regular equality and changes no coefficient, limit or acceptance condition. The preceding S12 source is preserved in s12_cache/s12_source_*.wl so completed corrected checkpoints remain source-bound.

Accepted corrected final hats: s12_final_hats.wl SHA256 875c95d4c77eeef9f9f2f4bbf83fbdc77067e3def04152e9cab98448190d0e6e; s12_result.wl SHA256 4ed44edf3d2c0274249792e21a8b1c7a9bff0ca9ec7c10f07cb072e54a1e45bd; s12_poles.wl SHA256 6c70a5d9106090223a72041d5986b3447a147b9ad6fb794b36f223a64fa6b06c; s12_frozen_inputs.json SHA256 b0e1f8cca4b2da06896329dba7babee43c5f90b1b52dcca01fb948f720c02dd2. Complete ordinary reconstruction and pole checks passed; changed delta boundaries were regenerated and matched exactly, and identical regular-boundary equalities reused their independently bound prior proofs. All final boundary values remain finite. The new final export is the current production input and supersedes the old 0c31db0e... result. MSbar, color/flavor, phase space, projectors and distribution conventions are unchanged. The old numerical consumer remains historical until its own regeneration.

Current corrected analytical comparison: ../bigTMD_comparison/Hqg_v3/s13_result.wl SHA256 2274e3f3514160789851e601731c658034f6bbe71e5bfd9096f17938bf5e91ee. All18 comparisons agree in the same MSbar/common-scale/SU(3)/decimal-reconstruction/physical-branch conventions. The previous four finite-delta differences were completely caused by the corrected S08 source error. Earlier comparison and numerical statements above refer to historical inputs. Current corrected hats remain s12_result.wl as identified in the new frozen manifest.

Numerical refresh consumer contract: bigTMD/ consumes the corrected accepted S12 hats using its documented current comparison contract; numerics/ rebuilds their dependent exports, full joint bins and plots. All old numerical output identities above are historical until replaced by a new executed acceptance receipt.
