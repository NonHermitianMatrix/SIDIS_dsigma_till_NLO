...
CHANNELS = ['Hqq_v2', 'Hgg', 'Hqqbar', 'Hqqprime', 'Hgq_v4', 'Hqg_v3']
FFS = ['KKP', 'Kretzer']
...
def derive_and_build():
    ...
    lum_labels = ['Hqq_group0', 'Hqq_group1', 'Hgg', 'Hqqbar',
                  ...
                  'Hqqprime_MixedIncomingPrimeCharge', 'Hgq_v4', 'Hqg_v3']
...
def prepare_reuse(folder):
    ...
    for name in ['s04_result','s06_result','dsigmapibydpt/s01_result','s10_cache/s10_consumer_contract_result']:
...
def main():
    ...
    def independent_seed(b):
        payload=(sha(CACHE/'s09_build_result')+b['id']+'Hgq_v4 independent').encode()
