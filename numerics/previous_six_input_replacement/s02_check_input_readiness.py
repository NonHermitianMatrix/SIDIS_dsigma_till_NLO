...
def main() -> int:
    ...
    expected_channels = {"Hqq_v2", "Hgg", "Hqqbar", "Hqqprime", "Hgq_v4", "Hqg_v3"}
    ...
    for channel in manifest["channels"]:
        for record in channel["files"]:
            ...
            if channel["channel"] == "Hgq_v4" and record["role"] == "convention_ledger_snapshot":
    ...
    result = {
        ...
        "replacement_authorization": {
            "instruction": "Use F hats given by Hgq_v4 instead of Hgq_v3 and regenerate the affected outputs.",
            "scope": "Replace the imported Hgq channel; preserve the five unchanged channel inputs and original PDF/FF/observable setup.",
        },
