...
def main() -> int:
    ...
    expected_channels = {"Hqq_v4", "Hgg_v2", "Hqqbar_v2", "Hqqprime_v2", "Hgq_v4", "Hqg_v3"}
    ...
    result = {
        ...
        "replacement_authorization": {
            "instruction": "Replace all active imports with Hqq_v4, Hgg_v2, Hqqbar_v2, Hqqprime_v2, Hgq_v4 and Hqg_v3.",
