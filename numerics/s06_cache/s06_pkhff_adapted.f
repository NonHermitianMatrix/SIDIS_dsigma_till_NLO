...
*    SELECTION AND READING OF THE GRID :
      ...
      IF (ISET.EQ.1) THEN
       IIREAD=11       
       OPEN(IIREAD,FILE='/home/physics/projects/AI_Assisted_SIDIS/scripts/numerics/vendor/ephox/plo.grid',
     #  STATUS= 'OLD')
      ELSEIF (ISET.EQ.2) THEN
       IIREAD=12
       OPEN(IIREAD,FILE='/home/physics/projects/AI_Assisted_SIDIS/scripts/numerics/vendor/ephox/pnlo.grid',
     #  STATUS= 'OLD')
       ELSEIF (ISET.EQ.3) THEN
       IIREAD=13
       OPEN(IIREAD,FILE='/home/physics/projects/AI_Assisted_SIDIS/scripts/numerics/vendor/ephox/klo.grid',
     #  STATUS= 'OLD')
      ELSEIF (ISET.EQ.4) THEN
       IIREAD=14
       OPEN(IIREAD,FILE='/home/physics/projects/AI_Assisted_SIDIS/scripts/numerics/vendor/ephox/knlo.grid',
     #  STATUS= 'OLD')
      ELSEIF (ISET.EQ.5) THEN
       IIREAD=15
       OPEN(IIREAD,FILE='/home/physics/projects/AI_Assisted_SIDIS/scripts/numerics/vendor/ephox/hlo.grid',
     # STATUS= 'OLD')
      ELSEIF (ISET.EQ.6) THEN
       IIREAD=16
       OPEN(IIREAD,FILE='/home/physics/projects/AI_Assisted_SIDIS/scripts/numerics/vendor/ephox/hnlo.grid',
     # STATUS= 'OLD')
