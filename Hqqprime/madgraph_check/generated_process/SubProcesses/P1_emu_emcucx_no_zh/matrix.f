...
C     
      ...
      INTEGER DENOM
      COMPLEX*16 AMP(NGRAPHS), JAMP(NCOLOR), TMP_JAMP(3)
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_2(W(1,6),W(1,7),GC_2,ZERO,ZERO,W(1,1))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,4),W(1,3),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO,ZERO,W(1,1))
      CALL FFV1_2(W(1,2),W(1,7),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,5),W(1,1),GC_11,AMP(3))
      CALL FFV1_1(W(1,5),W(1,7),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,2),W(1,6),W(1,1),GC_11,AMP(4))
      TMP_JAMP(2) = AMP(3) +  AMP(4)  ! used 2 times
      TMP_JAMP(1) = AMP(1) +  AMP(2)  ! used 2 times
      TMP_JAMP(3) = TMP_JAMP(2) +  TMP_JAMP(1)  ! used 2 times
      JAMP(1) = (-5.000000000000000D-01)*TMP_JAMP(3)
      JAMP(2) = (1.666666666666667D-01)*TMP_JAMP(3)
