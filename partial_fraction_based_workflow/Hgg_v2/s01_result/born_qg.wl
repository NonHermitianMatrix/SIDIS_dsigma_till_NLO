<|"graphs" -> TopologyList[Process -> {V[1], F[3, {1, Index[Colour, 2]}]} -> 
 ...
 "raw" -> FAFeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}, 
  ...
  {I*Spinor[Momentum[k2, D], 0, 1] . 
     ((-I)*gs*DiracGamma[LorentzIndex[Lor2, D], D]*SUNTF[{SUNIndex[Glu3]}, 
       SUNFIndex[Col4], SUNFIndex[Col2]]) . DiracGamma[Momentum[k1 + k2, D], 
   ...
   I*Spinor[Momentum[k2, D], 0, 1] . ((-I)*ee*eq*
      DiracGamma[LorentzIndex[Lor1, D], D]) . 
     DiracGamma[Momentum[-k1 + p, D], D] . 
     ((-I)*gs*DiracGamma[LorentzIndex[Lor2, D], D]*SUNTF[{SUNIndex[Glu3]}, 
       SUNFIndex[Col4], SUNFIndex[Col2]]) . Spinor[Momentum[p, D], 0, 1]*
