<|"g" -> {0, (-16*eq^2*gs^4*Nc*Q2*(Q2 + s)*(t - w))/
     (rho^2*(-1 + (2*Q2 + s + t)^2/(4*rho^2))*(Q2 + s + t - w)^2) - 
    (4*eq^2*gs^4*Nc*(2*t - w))/(Q2 + s + t - w)^2 - 
    (4*eq^2*gs^4*Nc*(2*Q2 + s - t)*(t - w)*((s*t + t^2 + 2*Q2*w + s*w - t*w)/
        (2*rho*(t - w)) + ArcCoth[(2*Q2 + s + t)/(2*rho)] - 
       ((2*Q2 + s + t)*(s*t + t^2 + 2*Q2*w + s*w - t*w)*
         ArcCoth[(2*Q2 + s + t)/(2*rho)])/(4*rho^2*(t - w))))/
     (rho*(Q2 + s + t - w)^2) + (4*eq^2*gs^4*Nc*Q2*(t - w)*(Q2 + s - t + w)*
     ...
     (rho^2*(-1 + (2*Q2 + s + t)^2/(4*rho^2))*(Q2 + s + t - w)^2) + 
    (4*eq^2*gs^4*Nc*(3*Q2*t + 2*s*t - 2*Q2*w - s*w)*
      Log[(1 + (2*Q2 + s + t)/(2*rho))/(-1 + (2*Q2 + s + t)/(2*rho))])/
     (rho*(Q2 + s + t - w)^2)}, 
 "pp" -> {0, (eq^2*gs^4*Nc*(t - w)^2)/(3*(Q2 + s + t - w)^2) - 
    (4*eq^2*gs^4*Nc*(Q2 + s)*(t - w)^2*((s*t + t^2 + 2*Q2*w + s*w - t*w)/
        (2*rho*(t - w)) + ArcCoth[(2*Q2 + s + t)/(2*rho)] - 
       ((2*Q2 + s + t)*(s*t + t^2 + 2*Q2*w + s*w - t*w)*
         ArcCoth[(2*Q2 + s + t)/(2*rho)])/(4*rho^2*(t - w))))/
