<|"graphs" -> TopologyList[Process -> {V[1], V[5, {Index[Gluon, 2]}]} -> 
 ...
 "raw" -> FAFeynAmpList[Process -> {{V[1], FourMomentum[Incoming, 1], 0, {}}, 
   ...
   FAFeynAmp[GraphID[Topology == 1, Generic == 1, Particles == 1, 
     ...
     FermionChain[FANonCommutative[FADiracSpinor[FourMomentum[Outgoing, 2], 
        ...
        FASUNT[Index[Gluon, 2], Index[Colour, 4], Index[Colour, 3]] - 
       I*FAGS*FANonCommutative[FADiracMatrix[Index[Lorentz, 2]], 
         FAChiralityProjector[1]]*FASUNT[Index[Gluon, 2], Index[Colour, 4], 
   ...
   FAFeynAmp[GraphID[Topology == 2, Generic == 1, Particles == 1, 
     ...
     FermionChain[FANonCommutative[FADiracSpinor[FourMomentum[Outgoing, 2], 
       ...
       I*FAGS*FANonCommutative[FADiracMatrix[Index[Lorentz, 2]], 
        ...
        -FourMomentum[Outgoing, 1], FCGV["MU"]]]]*SumOver[Index[Colour, 3], 
      3, External]*SumOver[Index[Colour, 4], 3, External]*
     SumOver[Index[Gluon, 2], 8, External]]], 
 "amplitudes" -> {(-I)*ee*eq*gs*Spinor[Momentum[k2, D], 0, 1] . 
     DiracGamma[LorentzIndex[Lor2, D], D] . DiracGamma[Momentum[k2 - p, D], 
      D] . DiracGamma[LorentzIndex[Lor1, D], D] . Spinor[-Momentum[k1, D], 0, 
    ...
    SUNTF[{SUNIndex[Glu2]}, SUNFIndex[Col4], SUNFIndex[Col3]], 
   (-I)*ee*eq*gs*Spinor[Momentum[k2, D], 0, 1] . 
     DiracGamma[LorentzIndex[Lor1, D], D] . DiracGamma[Momentum[-k1 + p, D], 
      D] . DiracGamma[LorentzIndex[Lor2, D], D] . Spinor[-Momentum[k1, D], 0, 
 ...
 "incoming_fields" -> {V[1], V[5]}, "outgoing_fields" -> 
  {-F[3, {1}], F[3, {1}]}, "all_diagram_count" -> 2, "symmetry_weight" -> 1|>
