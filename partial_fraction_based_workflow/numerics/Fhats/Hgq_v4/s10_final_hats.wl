(* Finite independent Hgq hats, gated by complete distributional IR cancellation. *)
$HistoryLength = 0;
...
Scan[Function[entry, gate[entry[[1]] <> " source identity", entry[[2]]["SourceHash"] ===
  ...
  {{"S02", born, "s02_born_and_projectors.wl"}, {"S07", virtual, "s07_renormalize_virtual.wl"},
...
hashes = Association@Table[name -> FileHash[FileNameJoin[{root, name}], "SHA256"],
  {name, {"s02_result.wl", "s07_result.wl", "s08_result.wl", "s09_result.wl"}}];
