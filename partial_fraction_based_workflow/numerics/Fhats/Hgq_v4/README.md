...
### Numerical reader acceptance

The S03 structural inspection accepted frozen S10 575ea96993eb9a86cfeddb6e10d61c0147e3bf74d35bc25eaf3dbb03fceb9bfe and verified its source, pole acceptance, pole-input identity and zero residues. Its own expression traversal measured charge degree 2, LO alphaS degree 1 and NLO alphaS degree 2. The plus logarithm was extracted as `ss/B`; both saved branches and `BoundaryAtTEqualsMinusS` are consumer inputs. Reader result: `../numerics/s03_result`, SHA256 `439599786d94bae6935ae120e077e7307a5265ec1c99ea74ac4418d6912bf941`; contract: `../numerics/s03_cache/Hgq_v4_consumer_contract`, SHA256 `4ebfc1139610324a2e0823277e9f53af2af4f188fdeee75968004feb8ff0e233`. S05 uses direct exact-coefficient export and independent Wolfram/native numerical comparisons; no supplied coefficient is corrected or normalized from a comparison curve.

### Accepted numerical coefficient export

`../numerics/s05_cache/Hgq_v4_result`, SHA256 `a7e2e317b9b43943a0f9c8e600754987ace0fded544046a637eb720bf913b675`, contains 30 directly exported coefficients covering F1/F2, both sign branches and the saved coordinate boundary. All exact-rational and original Wolfram benchmark gates passed. Source snapshot SHA256 `341c504e749a8b844ac6e8590bac7b78c163d026b04c763d11d225d0a278846d`; worker receipts and S03/S08 identities are bound in the aggregate. S05 confirmed the saved hats are partonic and independent of hadronic convolution variables; the S04 fragmentation Jacobian is applied once by the numerical consumer. Native translation and integration remain separately gated.

### Accepted numerical operation tables

`../numerics/s07_result`, SHA256 `ef847837c5e69a5e3244e37ba4ad019f43592965b3e17e5fb94e82d990fe1fa7`, accepted 708 direct Wolfram/native checks, including v4 branch-boundary values. It binds every scalar and paired operation-table hash and the 100-digit complex backend. The v4 table source is the accepted direct S05 export; the other five channel source receipts are preserved. S08 (`../numerics/s08_result`, SHA256 `c544f7b035061326310df8a84bcc506091614ceaf2322865328bd55d0cf82b88`) proves unchanged flavor actions, extracts the v4 normalized plus action from S03, and derives boundary coordinates from S04 using the Mathematica printer for exact-number exchange. Independent H1-point precision and convolution remain separate consumer gates.

### Accepted Hgq_v4 six-channel numerical consumer

The current numerical channel set is Hqq_v2, Hgg, Hqqbar, Hqqprime, Hgq_v4 and Hqg_v3. `../numerics/s05_cache/Hgq_v4_result` has SHA256 `a7e2e317b9b43943a0f9c8e600754987ace0fded544046a637eb720bf913b675`. Import manifest SHA256 `eee1b32a94c9b3f0500c76437035ce48b6a3dbdc8ae1d8add8fefdbc4da8aace`; six-channel result SHA256 `872f98c70e9b860387ed72bf61fad3013e986a599c5234ae6d154f5896cb2c17`; aggregation receipt SHA256 `d9d8de8d23d3d1bcbfd49f8d7c77f6e9b16e4cabd23cd52089105c023c0c44e3`. All 17 bins pass the original final numerical gates. Fifteen bins preserve the five unchanged channels with complete covariance; q0_p3 and q1_p2 use fresh full-channel samples after their saved covariance floors exceeded the new total precision target. Supplied channel coefficients and PDF/FF/cut conventions are unchanged by this numerical consumer. Figure receipt: `../numerics/dsigmapibydpt/s03_result`, SHA256 `22408cbc8d3cf4e093cc234a6cb356198c54a68981737579a8ff0e11bac5d8b4`. The v4 comparison limitation and uniform-azimuth convention remain explicit in the numerical output.
...
The separate [analytical report](../bigTMD_comparison/Hgq_v4/s04_result.md) compares this channel's unchanged current F hats with pinned BigTMD commit `6e97635d21a63b7975b2e7f5891edc0c35c4dc0c`. Both F hats agree in the stated comparison. Channel and all coefficient classes included. The exact-algebra claims are conditional on the declared reconstruction of printed decimal constants and the report's color, charge, scale, branch and distribution conventions.

Input SHA256: `575ea96993eb9a86cfeddb6e10d61c0147e3bf74d35bc25eaf3dbb03fceb9bfe`. Comparison SHA256: `2be3d838bfaa7bd35852c456672d6c84f2c88379a7246ddc35588e4d8ed4189e`. Report SHA256: `96d4d833d380545f8e4ef1a370a2a946123b0f30b991d33ff8e20251b605fdff`. The comparison-directory README and receipts bind the source, result, proof-cache and validation identities. No production expression or existing independent-validation caveat is superseded by this comparison.
