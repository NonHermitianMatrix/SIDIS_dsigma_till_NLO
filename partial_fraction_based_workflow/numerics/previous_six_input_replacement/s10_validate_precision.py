...
def main():
    parser=argparse.ArgumentParser();parser.add_argument('--dps',nargs='+',type=int,default=[100,140]);parser.add_argument('--scan-pilot',action='store_true');parser.add_argument('--use-pilot',action='store_true');parser.add_argument('--consumer-contract',action='store_true');parser.add_argument('--invariant-contract',action='store_true');parser.add_argument('--channels',nargs='+',default=['Hqq_v2','Hgq_v4']);parser.add_argument('--kernels-result',default='s07_result');parser.add_argument('--sample-source');options=parser.parse_args()
