 ...
 "InputRows" -> 
  {{1, -1, -1/4*((-Q2 + eps*EulerGamma*Q2 - s - eps*s + eps*EulerGamma*s)*
   ...
   {1, -1, ((-1 + eps*EulerGamma)*(2*Q2 + s)*(-1 + SUNN)*(1 + SUNN))/
      ...
      (8*Pi*s*SUNN^2)}, {1, -1, ((-1 + eps*EulerGamma)*(omega - 2*Q2 - 2*s)*
       (-1 + SUNN)*(1 + SUNN))/(8*Pi*s*SUNN^2) - 
     (eps*(omega - 2*Q2 - 2*s)*(-1 + SUNN)*(1 + SUNN)*Log[2])/
      (4*Pi*s*SUNN^2) - (eps*(omega - 2*Q2 - 2*s)*(-1 + SUNN)*(1 + SUNN)*
       Log[mu])/(4*Pi*s*SUNN^2) - (eps*(omega - 2*Q2 - 2*s)*(-1 + SUNN)*
       (1 + SUNN)*Log[Pi])/(8*Pi*s*SUNN^2)}, 
   ...
   {1, -1, ((-6*omega*Q2 - 7*eps*omega*Q2 + 6*eps*EulerGamma*omega*Q2 - 
        ...
        3*eps*s^2)*(-1 + SUNN)*(1 + SUNN))/(18*Pi*(omega - s)*s*SUNN) - 
     (eps*Q2*(2*omega + Q2)*(-1 + SUNN)*(1 + SUNN)*Log[2])/
      (3*Pi*(omega - s)*s*SUNN) - (eps*Q2*(2*omega + Q2)*(-1 + SUNN)*
       (1 + SUNN)*Log[mu])/(3*Pi*(omega - s)*s*SUNN) - 
     (eps*Q2*(2*omega + Q2)*(-1 + SUNN)*(1 + SUNN)*Log[Pi])/
      (6*Pi*(omega - s)*s*SUNN)}, 
   ...
   {1, -1, -1/4*((-3*omega*Q2 - 3*eps*omega*Q2 + 3*eps*EulerGamma*omega*Q2 + 
         ...
         eps*EulerGamma*s^2)*(-1 + SUNN)*(1 + SUNN))/(Pi*(omega - s)*s*
        SUNN) + (eps*(3*omega*Q2 - 2*Q2*s - s^2)*(-1 + SUNN)*(1 + SUNN)*
       Log[2])/(2*Pi*(omega - s)*s*SUNN) + 
     (eps*(3*omega*Q2 - 2*Q2*s - s^2)*(-1 + SUNN)*(1 + SUNN)*Log[mu])/
      (2*Pi*(omega - s)*s*SUNN) + (eps*(3*omega*Q2 - 2*Q2*s - s^2)*
       (-1 + SUNN)*(1 + SUNN)*Log[Pi])/(4*Pi*(omega - s)*s*SUNN)}, 
   {1, -2, ((-1 - eps + eps*EulerGamma)*Q2*(-1 + SUNN)*(1 + SUNN))/
      (2*Pi*SUNN) - (eps*Q2*(-1 + SUNN)*(1 + SUNN)*Log[2])/(Pi*SUNN) - 
     (eps*Q2*(-1 + SUNN)*(1 + SUNN)*Log[mu])/(Pi*SUNN) - 
     (eps*Q2*(-1 + SUNN)*(1 + SUNN)*Log[Pi])/(2*Pi*SUNN)}, 
   {1, -1, ((-omega^2 - eps*omega^2 + eps*EulerGamma*omega^2 + omega*Q2 + 
        eps*omega*Q2 - eps*EulerGamma*omega*Q2 + 2*omega*s + eps*omega*s - 
        2*eps*EulerGamma*omega*s + 2*Q2*s + 2*eps*Q2*s - 
        2*eps*EulerGamma*Q2*s - s^2 + eps*EulerGamma*s^2)*(-1 + SUNN)*
       (1 + SUNN))/(4*Pi*(omega - s)*s*SUNN) - 
     (eps*(omega^2 - omega*Q2 - 2*omega*s - 2*Q2*s + s^2)*(-1 + SUNN)*
       (1 + SUNN)*Log[2])/(2*Pi*(omega - s)*s*SUNN) - 
     (eps*(omega^2 - omega*Q2 - 2*omega*s - 2*Q2*s + s^2)*(-1 + SUNN)*
       (1 + SUNN)*Log[mu])/(2*Pi*(omega - s)*s*SUNN) - 
     (eps*(omega^2 - omega*Q2 - 2*omega*s - 2*Q2*s + s^2)*(-1 + SUNN)*
       (1 + SUNN)*Log[Pi])/(4*Pi*(omega - s)*s*SUNN)}, 
   {1, -2, -1/2*((-1 - eps + eps*EulerGamma)*Q2*(-1 + SUNN)*(1 + SUNN))/
       (Pi*SUNN) + (eps*Q2*(-1 + SUNN)*(1 + SUNN)*Log[2])/(Pi*SUNN) + 
     (eps*Q2*(-1 + SUNN)*(1 + SUNN)*Log[mu])/(Pi*SUNN) + 
     (eps*Q2*(-1 + SUNN)*(1 + SUNN)*Log[Pi])/(2*Pi*SUNN)}, 
   {1, -1, -1/4*((-omega^2 + eps*EulerGamma*omega^2 - 2*Q2^2 - 2*eps*Q2^2 + 
         2*eps*EulerGamma*Q2^2 + 2*omega*s - 2*eps*EulerGamma*omega*s - 
         2*s^2 + 2*eps*EulerGamma*s^2)*(-1 + SUNN)*(1 + SUNN))/
       (Pi*(omega - s)*s*SUNN) + (eps*(omega^2 + 2*Q2^2 - 2*omega*s + 2*s^2)*
       (-1 + SUNN)*(1 + SUNN)*Log[2])/(2*Pi*(omega - s)*s*SUNN) + 
     (eps*(omega^2 + 2*Q2^2 - 2*omega*s + 2*s^2)*(-1 + SUNN)*(1 + SUNN)*
       Log[mu])/(2*Pi*(omega - s)*s*SUNN) + 
     (eps*(omega^2 + 2*Q2^2 - 2*omega*s + 2*s^2)*(-1 + SUNN)*(1 + SUNN)*
       Log[Pi])/(4*Pi*(omega - s)*s*SUNN)}, 
   ...
   {1, -1, -1/4*((-omega - eps*omega + eps*EulerGamma*omega - Q2 + 
     ...
     (eps*(omega + Q2 - s)*(-1 + SUNN)*(1 + SUNN)*Log[Pi])/
      (4*Pi*(omega - s)*SUNN^2)}, 
   {1, -1, -1/8*((-1 + eps*EulerGamma)*s*(-1 + SUNN)*(1 + SUNN))/
   ...
   {1, -1, -1/18*((6*omega^3 + 13*eps*omega^3 - 6*eps*EulerGamma*omega^3 - 
     ...
     Log[Q2]*((-2*eps*Q2^3*s^2*(-1 + SUNN)*(1 + SUNN)*Log[mu])/
       ...
       SUNN)}, {1, -1, 
    ((-3*omega^2 - 6*eps*omega^2 + 3*eps*EulerGamma*omega^2 + 6*omega*Q2 + 
        12*eps*omega*Q2 - 6*eps*EulerGamma*omega*Q2 + 2*eps*Pi^2*Q2^2)*s*
     ...
     (eps*Q2^2*s*(omega^2 + 2*omega*Q2 - 2*omega*s + 2*Q2*s)*(-1 + SUNN)*
       ...
       SUNN) + Log[Q2]*((eps*Q2^2*s*(omega^2 + 2*omega*Q2 - 2*omega*s + 
         ...
         (omega - s)*SUNN) + (eps*Q2^2*s*(omega^2 + 2*omega*Q2 - 2*omega*s + 
          2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[omega])/(omega^3*Pi*(omega + Q2)*
         (omega - s)*SUNN) + (eps*Q2^2*s*(omega^2 + 2*omega*Q2 - 2*omega*s + 
          2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[Pi])/(2*omega^3*Pi*(omega + Q2)*
         (omega - s)*SUNN) + (eps*Q2^2*s*(omega^2 + 2*omega*Q2 - 2*omega*s + 
          2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[omega + Q2])/
        (2*omega^3*Pi*(omega + Q2)*(omega - s)*SUNN) + 
   ...
   {1, -1, ((-6*omega^4 - 3*eps*omega^4 + 6*eps*EulerGamma*omega^4 - 
     ...
     Log[Q2]*(-1/2*(eps*Q2*(omega^3 + 2*omega^2*Q2 + 2*omega*Q2^2 - 
           2*omega^2*s + 4*Q2^2*s + 2*omega*s^2 - 4*Q2*s^2)*(-1 + SUNN)*
   ...
   {1, -1, -1/12*((9*omega^2 + 18*eps*omega^2 - 9*eps*EulerGamma*omega^2 + 
     ...
     (eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 2*Q2*s)*
       ...
       SUNN) + Log[omega + Q2]*((eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 
     ...
     Log[Q2]*(-((eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 
           2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[mu])/(omega^3*Pi*(omega - s)*
          SUNN)) - (eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 
          2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[omega])/(omega^3*Pi*(omega - s)*
         SUNN) - (eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 
          2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[Pi])/(2*omega^3*Pi*(omega - s)*
         SUNN) - (eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 
          2*Q2*s)*(-1 + SUNN)*(1 + SUNN)*Log[omega + Q2])/
        (2*omega^3*Pi*(omega - s)*SUNN) + 
       ((omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 2*Q2*s)*
         (-1 + SUNN)*(1 + SUNN)*(-1 + 2*eps*EulerGamma - (2*I)*eps*Pi + 
          eps*PolyGamma[0, 1/2]))/(2*omega^3*Pi*(omega - s)*SUNN)) + 
     (eps*(omega + Q2)*s*(omega^2 + 2*omega*Q2 + 4*omega*s + 2*Q2*s)*
   ...
   {1, -1, ((6*omega^4 + 3*eps*omega^4 - 6*eps*EulerGamma*omega^4 + 
     ...
     (eps*(omega^3 + 2*omega^2*Q2 + 2*omega*Q2^2 + 2*omega^2*s + 
        8*omega*Q2*s + 4*Q2^2*s + 6*omega*s^2 + 4*Q2*s^2)*(-1 + SUNN)*
       (1 + SUNN)*PolyLog[2, (omega + Q2)/Q2])/(2*omega^2*Pi*(omega - s)*
       SUNN)}, {1, -1, 
    -1/12*(eps*Pi*(omega^2 + 2*omega*Q2 + 2*Q2^2 + 2*Q2*s + 2*s^2)*
 ...
 "CombinedRows" -> 
  {{1, -1, -1/36*((-1 + SUNN)*(1 + SUNN)*(9*eps*omega^2*Pi^2 + 
         ...
         12*omega*s*SUNN + 8*eps*omega*s*SUNN - 12*eps*EulerGamma*omega*s*
          SUNN - 12*s^2*SUNN - 8*eps*s^2*SUNN + 12*eps*EulerGamma*s^2*SUNN))/
       (Pi*(omega - s)*s*SUNN^2) + 
     ...
     (eps*(2*omega^2 + 4*omega*Q2 + 2*Q2^2 - 2*omega*s - 2*Q2*s + s^2)*
       (-1 + SUNN)*(1 + SUNN)*PolyLog[2, 
        (-1 + (-omega^2 + omega*s)/(omega*(omega - s)))/
         (-((omega + 2*Q2)/omega) + (-omega^2 + omega*s)/
           (omega*(omega - s)))])/(4*Pi*(omega - s)*s*SUNN^2)}, {1, -2, 0}}, 
