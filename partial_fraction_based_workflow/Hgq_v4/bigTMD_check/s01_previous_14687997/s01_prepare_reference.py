...
def main():
    ...
    sources.append(identity)
    output["Born"] = expressions(source, ("PgA", "PppA"))
    ...
    report = {"Channel": "Hgq", "BigTMDChannel": "1A", "SourceSHA256": hashlib.sha256(Path(__file__).read_bytes()).hexdigest(), "source": "https://github.com/JeffersonLab/BigTMD", "tree": TREE["sha"],
