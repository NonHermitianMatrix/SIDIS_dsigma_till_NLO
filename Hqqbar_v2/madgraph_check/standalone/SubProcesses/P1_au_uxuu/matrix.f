...
C     ----------
      ...
      CALL FFV1P0_3(W(1,3),W(1,4),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,5),W(1,7),GC_11,AMP(1))
      CALL FFV1P0_3(W(1,3),W(1,5),GC_11,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,5),W(1,9),GC_11,AMP(3))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,4),W(1,10),GC_11,AMP(4))
      CALL FFV1_1(W(1,4),W(1,1),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,3),W(1,6),W(1,10),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,6),W(1,8),GC_11,AMP(6))
      CALL FFV1_1(W(1,5),W(1,1),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,3),W(1,6),W(1,9),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,6),W(1,7),GC_11,AMP(8))
      ...
      TMP_JAMP(6) = TMP_JAMP(4) +  TMP_JAMP(2)  ! used 2 times
