...
C     ----------
      ...
      CALL FFV1_1(W(1,4),W(1,2),GC_11,ZERO,ZERO,W(1,3))
      CALL FFV1_2(W(1,5),W(1,7),GC_2,ZERO,ZERO,W(1,1))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,1),W(1,3),W(1,6),GC_11,AMP(1))
      CALL FFV1_2(W(1,5),W(1,6),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,3),W(1,7),GC_2,AMP(2))
      CALL FFV1_2(W(1,5),W(1,2),GC_11,ZERO,ZERO,W(1,3))
      CALL FFV1_1(W(1,4),W(1,7),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,9),W(1,6),GC_11,AMP(3))
      CALL FFV1_1(W(1,4),W(1,6),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,3),W(1,10),W(1,7),GC_2,AMP(4))
      CALL VVV1P0_1(W(1,2),W(1,6),GC_10,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,5),W(1,9),W(1,3),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,1),W(1,4),W(1,3),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,10),W(1,2),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,8),W(1,9),W(1,2),GC_11,AMP(8))
     ...
     $ +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(1)
      JAMP(2) = (-1.000000000000000D+00)*AMP(3)+(-1.000000000000000D
