   ...
   FAFeynAmp[GraphID[Topology == 1, Generic == 1, Classes == 1, Number == 2], 
    Integral[], (-I)*FAPolarizationVector[V[1], FourMomentum[Incoming, 1], 
     ...
     SumOver[Index[Colour, 3], 3, External]*SumOver[Index[Colour, 4], 3, 
      External]*SumOver[Index[Gluon, 2], 8, External]]], "GraphCount" -> 2, 
 "CouplingDegrees" -> {{1, 1}}, "IncomingSpecies" -> {photon, gluon}, 
 "OutgoingSpecies" -> {quark, antiquark}, 
 "Request" -> <|"Loops" -> 0, "Incoming" -> {V[1], V[5]}, 
   "Outgoing" -> {F[3, {1}], -F[3, {1}]}, "IncomingMomenta" -> {q, p}, 
   "OutgoingMomenta" -> {k1, k2}|>, "InputHash" -> 11022726386443270918844204\
9047360004727265580627867474025696680432420546554811|>
