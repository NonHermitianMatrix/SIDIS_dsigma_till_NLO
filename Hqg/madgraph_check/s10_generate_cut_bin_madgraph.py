...
BRIDGE = ROOT / "s03_libhqg_madgraph_bridge.so"
...
EXPECTED_SHA256 = {
    BRIDGE: "291f4adbbf93d960173186c9685bbd2ce9e2af95b692a4b7ccd2fbae78bf9abd",
    PARAM_CARD: "55bb009a781370ab3fdfb523be00d0c8f68ffec442d12eb41b8d2da50307cf64",
    POINT_VALIDATION: "a04e67cca4d71e31f1c45fcc3a6a0c3c0fce1c92b650328aaffc5fdca3213a70",
    LOCAL_EVALUATOR: "ab1b2cb3af9026055c70d5feb309da3d4ffe37ffb3c2526d7cadcf16c48309bd",
}
...
def main() -> None:
    ...
    outgoing_k3_gluon = final_momenta[:, 3]
    ...
    s13 = minkowski_dot(
        outgoing_k1_gluon + outgoing_k3_gluon,
        outgoing_k1_gluon + outgoing_k3_gluon,
    )
    s23 = minkowski_dot(
        outgoing_k2_up + outgoing_k3_gluon,
        outgoing_k2_up + outgoing_k3_gluon,
    )
    shat = s12 + s13 + s23
    u1 = minkowski_dot(
        incoming_quark[None, :] - outgoing_k1_gluon,
        incoming_quark[None, :] - outgoing_k1_gluon,
    )
    u2 = minkowski_dot(
    ...
    u3 = minkowski_dot(
        incoming_quark[None, :] - outgoing_k3_gluon,
        incoming_quark[None, :] - outgoing_k3_gluon,
    )
    ...
    t3 = minkowski_dot(photon - outgoing_k3_gluon, photon - outgoing_k3_gluon)
    ...
    for accepted_position, trial_index in enumerate(selected_indices):
        ...
        average, diagnostics = four_angle_average(
            library, lab_momenta, alpha_s, identity_correction
        )
    ...
    metadata = {
        "stage": "HqgFiniteCutMadGraphSample-v1",
        "status": "complete",
        "sqrt_s_gev": SQRT_S,
        "s_gev2": S,
        ...
        "local_and_generated_final_order": ["g(k1)", "u(k2)", "g(k3)"],
        "cuts": CUTS,
