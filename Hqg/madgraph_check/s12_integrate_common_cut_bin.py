...
EXPECTED_SHA256 = {
    S10_METADATA: "78881497b9341b00d0346781657d795f8459bdc4d02ca58ebee379ec12de0b1d",
    S11_POINTS: "4f3439167d6567dc35d2bca0f6e6534ec6f6d0e26daed273f47875fac372d270",
    S11_SUMMARY: "95eddd1c31df107af425ae4ff7c5e4a0bf1a4ff56fc780ac5587ac3bd71984f7",
}
...
def main() -> None:
    ...
    if (
        ...
        or metadata.get("stage") != "HqgFiniteCutMadGraphSample-v1"
        or pointwise_summary.get("status") != "complete"
        or pointwise_summary.get("stage")
        != "HqgFiniteCutPointwiseComparison-v1"
    ...
    output = {
        "stage": "HqgFiniteCutIntegratedComparison-v1",
        "status": "complete",
    ...
    if (
        ...
        or reloaded.get("stage") != "HqgFiniteCutIntegratedComparison-v1"
