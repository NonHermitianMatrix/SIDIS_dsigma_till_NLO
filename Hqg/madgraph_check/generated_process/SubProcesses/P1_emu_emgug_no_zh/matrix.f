...
C     Amplitude(s) for diagram number 5
      ...
      CALL VVV1P0_1(W(1,4),W(1,6),GC_10,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,3),W(1,5),W(1,9),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,1),W(1,9),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,3),W(1,8),W(1,4),GC_11,AMP(8))
      TMP_JAMP(1) = AMP(6) +  AMP(7)  ! used 2 times
