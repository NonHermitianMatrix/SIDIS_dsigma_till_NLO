...
EXPECTED_SHA256 = {
    ...
    LOCAL_POINT: "518e1b940c177027f52c82e7d2ebed10d6551e37b5d89aa7223939fbcce929f9",
}
...
def main() -> None:
    ...
    if (
        local_point.get("stage") != "HqgLocalTensorAndProjectionValidation-v1"
    ...
    identity_correction = int(
        local_point["fixed_orientation"]["selected_identity_correction"]
    )
    ...
    output = {
        "stage": "HqgMadGraphAzimuthalAverageValidation-v1",
        "status": "complete",
