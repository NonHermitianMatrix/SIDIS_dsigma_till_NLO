C     PY ((11, 21), (-2, 2, 11, 21)) : (11, 21, 11, 21, 2, -2) # M0_ 1
...
CF2PY double precision, intent(in) :: SCALE2
      ...
      IF(11.EQ.PDGS(1).AND.21.EQ.PDGS(2).AND.11.EQ.PDGS(3)
     $ .AND.21.EQ.PDGS(4).AND.2.EQ.PDGS(5).AND.-2.EQ.PDGS(6)
