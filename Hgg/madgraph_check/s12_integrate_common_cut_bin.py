...
EXPECTED_SHA256 = {
    S10_METADATA: "28cd203dbc58420c573c34ce621118cac7d4545d578d26d35dfd7b2d7887faae",
    S11_POINTS: "ff10a84ffe4a929fb6229c2f5e83dfbe0de99f1b8678a34a3f9d3d59e0e788dc",
    S11_SUMMARY: "8c4d29ed4bd9ef6a300ded2f2ff4a0158a433e26fa63a9d44b5497c6b2088131",
}
...
def main() -> None:
    ...
    if (
        ...
        or metadata.get("stage") != "HggFiniteCutMadGraphSample-v1"
        or pointwise_summary.get("status") != "complete"
        or pointwise_summary.get("stage")
        != "HggFiniteCutPointwiseComparison-v1"
    ...
    output = {
        "stage": "HggFiniteCutIntegratedComparison-v1",
        "status": "complete",
    ...
    if (
        ...
        != "HggFiniteCutIntegratedComparison-v1"
