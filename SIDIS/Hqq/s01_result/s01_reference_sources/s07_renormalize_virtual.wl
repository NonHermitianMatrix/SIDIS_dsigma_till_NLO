...
configuration = KernelConfiguration["localhost", "KernelCommand" ->
  "/u/local/apps/mathematica/13.1/Executables/WolframKernel",
  "KernelCount" -> Min[8, slots, Length[{quarkData, gluonData, flavorData}]], "TimeConstraint" -> 60];
...
(* External fields belong to the same generated Hqq process. *)
