# Hqqbar: SIDIS through NLO with reverse unitarity
...
Final result SHA256: `28cf4119f7db84a58a76f88aee9e14ace618f5146af6d9c1a1c602c6179bd21e`. Executed final shared source SHA256: `c56f0f20deca9c2100218304eadbfdecb139826c6d36dd2e06bf31b6895a36fa`. The [BigTMD report](../bigTMD_comparison/Hqqbar/s04_result.md) records 2/2 exact comparisons and 4/4 high-precision checks passing, with the reference-reconstruction and driver scope stated there.
...
Incoming quark p, observed same-flavor antiquark k1, unobserved identical quarks k2 and k3. There is no virtual contribution at this order.

The flavor is fixed and eq2 denotes its squared charge. The real tensor has no spectator symmetry weight; use the generated spectator count and apply the weight once in assembly. Initial subtraction uses q to g with gamma* g to qbar q; final subtraction uses gamma* q to g q with g to qbar, once each for the fixed flavor.
...
No old angular pole/finite vector or endpoint result is imported. The new cut integral stage must establish its own endpoint behavior.
...
`../../Hqqbar_v2`. Its complete convention ledger is preserved in
...
S11 accepted: job14692875, source SHA256dc86aa7f7f95265bbd37465ee4e0cfa55e99fb86b6e2e3d6616e4ec9e0432942, channel result SHA2561cbba226ac68541860a86711f4d1cdb686159ad2e1ac07108f8c2b6ea4b17e55. All original charge/projector components are expressed in the eight Kira cut masters, with rational regulator/soft valuations. Peak1074868224 bytes; no OOM.
...
S16 accepted: job14692913; source SHA256 ee121b6a83eec08225a20f7cd3dc13faf404f990bcba89142d206f47f7acf52a; channel result SHA256 5845217f51ea3f27760cbe031363942504e368984ac93d7c339b63da0ed6427b. The source-selected subtraction/projector block passed support, Jacobian, color and paper-projector gates. Its evaluated MSbar phase and per-channel Born convolutions are in s16_result.wl; exact extracted source and intermediate results are in s16_result/. Peak928432128 bytes; no OOM. No real integral or endpoint distribution is evaluated here.
...
| File | SHA256 |
|---|---|
| `s11_result/s11_result.wl` | `28cf4119f7db84a58a76f88aee9e14ace618f5146af6d9c1a1c602c6179bd21e` |
| `s11_result/s11_F1_hat.wl` | `f0a51ede90dd70f9e15af133df360b02f1a52c11da906f3929ba113663c5fc9b` |
| `s11_result/s11_F2_hat.wl` | `cf700cca7290a8a99a567565a1af1ce8173430a78997dbe076c4e5d492be6b6d` |

Its 2 final Laurent/pole checkpoints in `s11_result/s11_cache/973a829b054aa9e5f0527ac3917ef36d928c18f9725366dabf138268cd90cefc/` are all accepted. The real-to-phase normalization gate passed. For channels with a virtual contribution, both tensor projectors passed the open-branch and common-boundary pole gates. The common virtual boundary is a Wolfram symbolic limit, so direct substitution into individually singular terms is not needed. The run receipt is `../common/s20_result/s20_execution.json`; its log is `../common/s20_result/s20_run.log`, and the six-channel hash manifest is `../common/s20_result/s20_result.wl`. The recorded remote cache path in the result maps to the local relative cache directory given here.
