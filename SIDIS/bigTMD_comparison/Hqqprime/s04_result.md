# Hqqprime: new SIDIS F hats versus BigTMD

**Both F hats agree: 2/2 exact comparisons and 4/4 90-digit physical-point checks passed.**

Both complete finite NLO hats agree as symbolic functions. Independent charge symbols remain formal. Finite ordinary remainders from the reference plus functions are included. All three charge sectors are included.
...
The existing source-bound comparison records that the pinned public driver skips nonzero ordinary remainders from this channel's plus functions. This report compares the complete coefficient files. See the [existing driver finding](../../../bigTMD_comparison/Hqqprime_v2/s04_result.md).

- [Current production result](../../Hqqprime/s11_result/s11_result.wl).
...
Production SHA256: `26e5c071f4a005d2682b8b3e3a0af3b25d0e0dbc904863a3621da37c8f3d291b`.

Comparison SHA256: `4339e60aabf32e42336191d6056418df137f37dd83500b81b6d293ac60bf69fb`.
