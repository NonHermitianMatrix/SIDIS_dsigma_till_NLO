...
83, "Function" -> Log[2*Pi], "Assumptions" -> 
  Q^2 > 0 && s > (radius^2 - s^2 - 2*s*t - t^2)/(4*Q^2) > 0 && 
   -Q^2 - s + (radius^2 - s^2 - 2*s*t - t^2)/(4*Q^2) < t < 
   ...
   Element[eq | eqp | eq2 | chargeSum | otherChargeMoment[1] | 
     otherChargeMoment[2], Reals] && radius > 0, "Value" -> Log[2] + Log[Pi]|>
