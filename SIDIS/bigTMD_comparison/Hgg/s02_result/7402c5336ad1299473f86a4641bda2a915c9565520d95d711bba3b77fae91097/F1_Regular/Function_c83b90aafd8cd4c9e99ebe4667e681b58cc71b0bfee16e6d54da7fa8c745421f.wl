...
83, "Function" -> Log[(4*Q^2*(s - (radius^2 - s^2 - 2*s*t - t^2)/(4*Q^2))*
     (-t + (radius^2 - s^2 - 2*s*t - t^2)/(4*Q^2)))/
    ((radius^2 - s^2 - 2*s*t - t^2)*(Q^2 + s + t - 
 ...
 "Value" -> -Log[radius - s - t] - Log[2*Q^2 - radius + s + t] - 
   Log[radius + s + t] - Log[2*Q^2 + radius + s + t] + 
   Log[radius^2 - s^2 - 4*Q^2*t - 2*s*t - t^2] + 
   Log[-radius^2 + 4*Q^2*s + s^2 + 2*s*t + t^2]|>
