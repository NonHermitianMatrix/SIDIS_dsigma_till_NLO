...
83, "Function" -> Log[(Q^2 + s + t - (radius^2 - s^2 - 2*s*t - t^2)/(4*Q^2))/
 ...
 "Value" -> 2*Log[2] + 2*Log[Q] + Log[2*Q^2 - radius + s + t] + 
   Log[2*Q^2 + radius + s + t] - Log[radius^2 - s^2 - 4*Q^2*t - 2*s*t - 
     t^2] - Log[-radius^2 + 4*Q^2*s + s^2 + 2*s*t + t^2]|>
