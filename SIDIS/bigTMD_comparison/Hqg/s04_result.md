# Hqg: new SIDIS F hats versus BigTMD

**Both F hats agree: 18/18 exact comparisons and 36/36 90-digit physical-point checks passed.**

Both Born hats and every F1/F2 delta/L0/L1/regular coefficient on both open coordinate branches agree.
...
The existing comparison records this channel and all coefficient classes in the pinned driver. See the [existing driver finding](../../../bigTMD_comparison/Hqg_v3/s04_result.md).

- [Current production result](../../Hqg/s17_result/s17_result.wl).
...
Production SHA256: `6f45a83b0c2f2dce2d568431f7eb2fc5e9ba43e0fc612882092b312671ed590b`.

Comparison SHA256: `df68e1aa967b3aa67809785ae5e64ab7c742edd4c0f9e1961719342006e54a7c`.
