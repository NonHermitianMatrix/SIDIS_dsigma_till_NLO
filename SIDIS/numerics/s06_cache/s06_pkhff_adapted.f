...
c       dimension uff(2), dff(2), sff(2), cff(2), bff(2)
c       integer n, m, iset, icharge, ifini
c       COMMON / FRAGINI / IFINI
c       ifini = 0
c       iset = 2
c       icharge = 1
c       q2 = 100.d0
c       do 10 n = 1, 99
c       z = dble(n) * 1.d-2
c       call PKHFF(ISET,ICHARGE,Z,Q2,uff,dff,sff,cff,bff,gff)
c       write(6,90) z, uff(1), uff(2), dff(1), dff(2), sff(1), sff(2),
c     >             cff(1), bff(1), gff
c       write(6,*)
c 10    continue
...
* ... Z AND Q**2 VALUES OF THE GRID :
     ...
     8             1.0d0 /
*
*     set IFINI to zero for first call of subroutine
*     after having read the grids IFINI is set to 1
*     save statement insures that IFINI=1 will be remembered in 
*     subsequent calls of subroutine
	DATA IFINI / 0 /
	save IFINI 
...
*    SELECTION AND READING OF THE GRID :
      ...
      IF (ISET.EQ.1) THEN
       IIREAD=11       
       OPEN(IIREAD,FILE='/u/scratch/r/rushil/AI_Assisted_SIDIS/SIDIS_20260907/numerics/vendor/ephox/plo.grid',
     #  STATUS= 'OLD')
      ELSEIF (ISET.EQ.2) THEN
       IIREAD=12
       OPEN(IIREAD,FILE='/u/scratch/r/rushil/AI_Assisted_SIDIS/SIDIS_20260907/numerics/vendor/ephox/pnlo.grid',
     #  STATUS= 'OLD')
       ELSEIF (ISET.EQ.3) THEN
       IIREAD=13
       OPEN(IIREAD,FILE='/u/scratch/r/rushil/AI_Assisted_SIDIS/SIDIS_20260907/numerics/vendor/ephox/klo.grid',
     #  STATUS= 'OLD')
      ELSEIF (ISET.EQ.4) THEN
       IIREAD=14
       OPEN(IIREAD,FILE='/u/scratch/r/rushil/AI_Assisted_SIDIS/SIDIS_20260907/numerics/vendor/ephox/knlo.grid',
     #  STATUS= 'OLD')
      ELSEIF (ISET.EQ.5) THEN
       IIREAD=15
       OPEN(IIREAD,FILE='/u/scratch/r/rushil/AI_Assisted_SIDIS/SIDIS_20260907/numerics/vendor/ephox/hlo.grid',
     # STATUS= 'OLD')
      ELSEIF (ISET.EQ.6) THEN
       IIREAD=16
       OPEN(IIREAD,FILE='/u/scratch/r/rushil/AI_Assisted_SIDIS/SIDIS_20260907/numerics/vendor/ephox/hnlo.grid',
     # STATUS= 'OLD')
