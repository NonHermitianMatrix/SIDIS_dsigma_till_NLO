...
continueMaster[master_,data_] := Catch[Module[
  ...
  signs=DeleteDuplicates[Cases[parent["Propagators"],StandardPropagatorDenominator[_,_,_,{_,i0_}]:>i0,Infinity]];
...
Do[
  ...
  Do[
    ...
    hermitian=bounded[reduce[FullSimplify[ComplexExpand[interference+Conjugate[interference],
      TargetFunctions->{Re,Im}],physical&&Element[eps,Reals]]],"Hermitian interference"];
