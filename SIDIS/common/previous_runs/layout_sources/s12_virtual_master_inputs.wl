...
reduction = Get[FileNameJoin[{root, "s09_result.wl"}]];
gate["accepted virtual Kira reduction", TrueQ[reduction["Accepted"]] &&
  reduction["SourceHash"] === FileHash[FileNameJoin[{root, "s09_reduce_virtual.wl"}], "SHA256"]];
...
directory = FileNameJoin[{root, "common", "s12_virtual_inputs"}];
...
put[<|"VirtualMasterParents" -> entries, "ParentInputs" -> parentInputs,
  "SourceHash" -> sourceHash, "ReductionHash" -> FileHash[FileNameJoin[{root, "s09_result.wl"}], "SHA256"],
  "Accepted" -> True, "IntegralEvaluationPerformed" -> False,
  "PhysicalContinuationPerformed" -> False|>, FileNameJoin[{root, "s12_result.wl"}]];
