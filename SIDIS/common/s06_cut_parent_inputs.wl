...
gate["accepted real Kira reduction", TrueQ[reduction["Accepted"]] &&
  reduction["SourceHash"] === sidisHash[sidisPath[{root, "s04_reduce_real.wl"}], "SHA256"]];
...
directory = sidisPath[{root, "common", "s06_parent_inputs"}];
...
put[<|"CutMasterParents" -> entries, "ParentInputs" -> parentInputs,
  "SourceHash" -> sourceHash, "ReductionHash" -> sidisHash[sidisPath[{root, "s04_result.wl"}], "SHA256"],
  "Accepted" -> True, "IntegralEvaluationPerformed" -> False,
  "CutExtractionPerformed" -> False|>, sidisPath[{root, "s06_result.wl"}]];
