...
01, "Value" -> <|"Ordinary" -> 
   ...
   "Soft" -> <|1 -> {{1, -1, ((-6 - eps + 6*eps*EulerGamma)*s*(-1 + SUNN)*
           (1 + SUNN))/(144*Pi*(omega - s)) - (eps*s*(-1 + SUNN)*(1 + SUNN)*
           Log[2])/(12*Pi*(omega - s)) - (eps*s*(-1 + SUNN)*(1 + SUNN)*
           Log[mu])/(12*Pi*(omega - s)) - (eps*s*(-1 + SUNN)*(1 + SUNN)*
           Log[Pi])/(24*Pi*(omega - s))}}, 
     -1 -> {{1, -1, -1/144*((-6 - eps + 6*eps*EulerGamma)*s*(-1 + SUNN)*
            (1 + SUNN))/(Pi*(omega + s)) + (eps*s*(-1 + SUNN)*(1 + SUNN)*
           Log[2])/(12*Pi*(omega + s)) + (eps*s*(-1 + SUNN)*(1 + SUNN)*
           Log[mu])/(12*Pi*(omega + s)) + (eps*s*(-1 + SUNN)*(1 + SUNN)*
           Log[Pi])/(24*Pi*(omega + s))}}|>|>|>
