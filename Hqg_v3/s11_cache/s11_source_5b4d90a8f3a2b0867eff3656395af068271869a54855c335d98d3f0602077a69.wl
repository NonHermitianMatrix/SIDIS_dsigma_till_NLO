...
softTerm[coefficient_, map_, powers_, sign_] := Module[{assumptions, replacement, prefactor,
  ...
  rules = FullSimplify[map["Rules"] /. replacement,
    assumptions && s23 > 0 && (input["PhysicalRegion"] /. replacement)];
  prefactor = FullSimplify[coefficient /. replacement, assumptions && s23 > 0];
  {j, l} = powers;
  If[map["Type"] === "ML",
    dEnd = FullSimplify[Limit[d /. rules, s23 -> 0], assumptions];
