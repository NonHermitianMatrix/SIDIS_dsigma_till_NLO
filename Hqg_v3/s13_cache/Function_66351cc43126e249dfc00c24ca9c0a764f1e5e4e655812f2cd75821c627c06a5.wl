<|"InputHash" -> 
  210384475603406745113660887820678598671365219207061826627096751822386942727\
56, "Function" -> Arg[1 - omega/(omega + 2*Q^2)], 
 "Assumptions" -> Q > 0 && mu > 0 && Inequality[s, Greater, 
   ...
   alphaS > 0 && Element[eq, Reals] && omega > 0 && radius > 0, "Value" -> 0|>
