...
CF2PY integer, intent(in) :: new_value
      ...
      SUBROUTINE M1_GET_NHEL_ENTRY()
      INTEGER M1_NHEL(6,64)
      COMMON/M1_PROCESS_NHEL/M1_NHEL
      CALL F77_M1_GET_NHEL_ENTRY(M1_NHEL)

      RETURN
      END

      SUBROUTINE M2_GET_NHEL_ENTRY()
      INTEGER M2_NHEL(6,64)
      COMMON/M2_PROCESS_NHEL/M2_NHEL
      CALL F77_M2_GET_NHEL_ENTRY(M2_NHEL)
