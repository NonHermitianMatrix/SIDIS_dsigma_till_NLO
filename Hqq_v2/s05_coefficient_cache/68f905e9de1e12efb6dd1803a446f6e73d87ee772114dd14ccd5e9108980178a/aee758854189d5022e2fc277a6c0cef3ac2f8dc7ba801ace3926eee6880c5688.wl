<|"Stage" -> "HqqV2S05CoefficientTask-v1", 
 ...
 "TaskLabel" -> "Pg/Hqq;gg", "TaskIndex" -> 28, 
 "TaskInputSHA256" -> 
  "aee758854189d5022e2fc277a6c0cef3ac2f8dc7ba801ace3926eee6880c5688", 
 "TaskByteCount" -> 17864, "TaskLeafCount" -> 566, 
 "WorkerLaunch" -> <|"KernelCount" -> 2, "KernelIDs" -> {27, 28}, 
   "Versions" -> {15., 15.}, "OrderProbe" -> True, "WorkerProbe" -> True|>, 
 "PhaseCoefficientData" -> 
  <|0 -> -1/32*(FAGS^4*(-1 + SUNN^2)*(-(Q2*s23) + s23^2 + Q2*t1 - s23*t1 - 
        s23*u1)*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/
      (Pi^6*s23^2*(s23 - t1)*t1*(-Q2 + s23 - t1 - u1)^2*(Q2 + t1 + u1)), 
   1 -> (FAGS^4*(-1 + SUNN^2)*(-(Q2*s23) + s23^2 + Q2*t1 - s23*t1 - s23*u1)*
       FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/(16*Pi^6*s23^2*(s23 - t1)*t1*
     ...
     (FAGS^4*(-1 + SUNN^2)*(-(Q2*s23) + s23^2 + Q2*t1 - s23*t1 - s23*u1)*
      ...
      (32*Pi^6*s23^2*(s23 - t1)*t1*(-Q2 + s23 - t1 - u1)^2*(Q2 + t1 + u1)), 
   2 -> -1/32*(FAGS^4*(-1 + SUNN^2)*(-(Q2*s23) + s23^2 + Q2*t1 - s23*t1 - 
         s23*u1)*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/
       (Pi^6*s23^2*(s23 - t1)*t1*(-Q2 + s23 - t1 - u1)^2*(Q2 + t1 + u1)) + 
     (FAGS^4*(-1 + SUNN^2)*(-(Q2*s23) + s23^2 + Q2*t1 - s23*t1 - s23*u1)*
       FCGV["EL"]^2*HqqV2Charge["UpType"]^2*(Log[16*Pi] + PolyGamma[0, 1/2]))/
      (16*Pi^6*s23^2*(s23 - t1)*t1*(-Q2 + s23 - t1 - u1)^2*(Q2 + t1 + u1)) - 
     (FAGS^4*(-1 + SUNN^2)*(-(Q2*s23) + s23^2 + Q2*t1 - s23*t1 - s23*u1)*
      ...
      (128*Pi^6*s23^2*(s23 - t1)*t1*(-Q2 + s23 - t1 - u1)^2*
