<|"Stage" -> "HqqV2S05CoefficientTask-v1", 
 ...
 "TaskLabel" -> "Pg/Hqq;gg", "TaskIndex" -> 16, 
 "TaskInputSHA256" -> 
  "27c777e636dea230e67391a73bd338d44d9655404fd56946a7c20be8dcc03452", 
 "TaskByteCount" -> 17720, "TaskLeafCount" -> 560, 
 ...
 "PhaseCoefficientData" -> 
  <|0 -> (FAGS^4*(-1 + SUNN^2)*(Q2^2 - Q2*s23 + Q2*t1 - s23*t1 + Q2*u1)*
      FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/(16*Pi^6*s23^2*(s23 - t1)*t1^2*
      (-Q2 + s23 - t1 - u1)), 
   1 -> -1/8*(FAGS^4*(-1 + SUNN^2)*(Q2^2 - Q2*s23 + Q2*t1 - s23*t1 + Q2*u1)*
        FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/(Pi^6*s23^2*(s23 - t1)*t1^2*
        (-Q2 + s23 - t1 - u1)) + (FAGS^4*(-1 + SUNN^2)*
       (Q2^2 - Q2*s23 + Q2*t1 - s23*t1 + Q2*u1)*FCGV["EL"]^2*
       HqqV2Charge["UpType"]^2*(Log[16*Pi] + PolyGamma[0, 1/2]))/
      (16*Pi^6*s23^2*(s23 - t1)*t1^2*(-Q2 + s23 - t1 - u1)), 
   2 -> (FAGS^4*(-1 + SUNN^2)*(Q2^2 - Q2*s23 + Q2*t1 - s23*t1 + Q2*u1)*
       FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/(16*Pi^6*s23^2*(s23 - t1)*t1^2*
       (-Q2 + s23 - t1 - u1)) - (FAGS^4*(-1 + SUNN^2)*
       (Q2^2 - Q2*s23 + Q2*t1 - s23*t1 + Q2*u1)*FCGV["EL"]^2*
       HqqV2Charge["UpType"]^2*(Log[16*Pi] + PolyGamma[0, 1/2]))/
      (8*Pi^6*s23^2*(s23 - t1)*t1^2*(-Q2 + s23 - t1 - u1)) + 
     (FAGS^4*(-1 + SUNN^2)*(Q2^2 - Q2*s23 + Q2*t1 - s23*t1 + Q2*u1)*
      ...
      (64*Pi^6*s23^2*(s23 - t1)*t1^2*(-Q2 + s23 - t1 - u1))|>, 
