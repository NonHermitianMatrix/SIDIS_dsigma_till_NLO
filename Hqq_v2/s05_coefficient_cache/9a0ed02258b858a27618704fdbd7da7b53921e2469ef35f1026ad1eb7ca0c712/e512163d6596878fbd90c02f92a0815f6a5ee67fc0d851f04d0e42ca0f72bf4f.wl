<|"Stage" -> "HqqV2S05CoefficientTask-v1", 
 ...
 "TaskLabel" -> "Pg/Hqq;q_qbar_sameFlavor", "TaskIndex" -> 40, 
 "TaskInputSHA256" -> 
  "e512163d6596878fbd90c02f92a0815f6a5ee67fc0d851f04d0e42ca0f72bf4f", 
 "TaskByteCount" -> 7264, "TaskLeafCount" -> 233, "TaskTermCount" -> 1, 
 ...
 "PhaseCoefficientData" -> 
  <|0 -> (FAGS^4*Q2^2*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
   ...
   1 -> (-(FAGS^4*Q2^2*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2) + 
     ...
     ((FAGS^4*Q2^2*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
        ...
        FAGS^4*Q2*u1^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
        FAGS^4*Q2*SUNN^2*u1^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)*
       (Log[16*Pi] + PolyGamma[0, 1/2]))/(32*Pi^6*SUNN*(Q2 - s23 + t1 + u1)), 
   2 -> ((-(FAGS^4*Q2^2*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2) + 
        ...
        FAGS^4*Q2*u1^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
        FAGS^4*Q2*SUNN^2*u1^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)*
       (Log[16*Pi] + PolyGamma[0, 1/2]))/(32*Pi^6*SUNN*
       (Q2 - s23 + t1 + u1)) + 
     ((FAGS^4*Q2^2*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
        FAGS^4*Q2^2*SUNN^2*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
        FAGS^4*Q2*t1*u1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
       ...
       (-Pi^2 + 2*Log[16]^2 + 4*Log[16]*Log[Pi] + 2*Log[Pi]^2 + 
        ...
        2*PolyGamma[0, 1/2]^2))/(128*Pi^6*SUNN*(Q2 - s23 + t1 + u1))|>, 
