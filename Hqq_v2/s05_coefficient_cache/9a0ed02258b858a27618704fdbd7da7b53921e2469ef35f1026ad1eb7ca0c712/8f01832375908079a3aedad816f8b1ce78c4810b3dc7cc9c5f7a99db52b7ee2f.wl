<|"Stage" -> "HqqV2S05CoefficientTask-v1", 
 ...
 "TaskLabel" -> "Pg/Hqq;q_qbar_sameFlavor", "TaskIndex" -> 115, 
 "TaskInputSHA256" -> 
  "8f01832375908079a3aedad816f8b1ce78c4810b3dc7cc9c5f7a99db52b7ee2f", 
 "TaskByteCount" -> 4576, "TaskLeafCount" -> 141, "TaskTermCount" -> 1, 
 "WorkerLaunch" -> <|"KernelCount" -> 2, "KernelIDs" -> {108, 109}, 
 ...
 "PhaseCoefficientData" -> 
  <|0 -> (-3*FAGS^4*s23*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
      3*FAGS^4*s23*SUNN^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
      4*FAGS^4*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
      4*FAGS^4*SUNN^2*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/
     (256*Pi^6*SUNN*t1*(Q2 + t1)^2), 
   1 -> (3*FAGS^4*s23*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
       3*FAGS^4*s23*SUNN^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
       4*FAGS^4*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
       4*FAGS^4*SUNN^2*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)/
      (256*Pi^6*SUNN*t1*(Q2 + t1)^2) + 
     ((-3*FAGS^4*s23*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
        3*FAGS^4*s23*SUNN^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
        4*FAGS^4*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
        4*FAGS^4*SUNN^2*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)*
       (Log[16*Pi] + PolyGamma[0, 1/2]))/(256*Pi^6*SUNN*t1*(Q2 + t1)^2), 
   2 -> ((3*FAGS^4*s23*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
        3*FAGS^4*s23*SUNN^2*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 - 
        4*FAGS^4*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2 + 
        4*FAGS^4*SUNN^2*t1*FCGV["EL"]^2*HqqV2Charge["UpType"]^2)*
       (Log[16*Pi] + PolyGamma[0, 1/2]))/(256*Pi^6*SUNN*t1*(Q2 + t1)^2) + 
